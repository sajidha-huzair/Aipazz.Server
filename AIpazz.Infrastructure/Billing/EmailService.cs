...
namespace AIpazz.Infrastructure.Billing
{
    ...
    {
        public async Task SendEmailToTeamCreator(string toEmail, string subject, string htmlBody)
        {

            var apiKey = "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";
